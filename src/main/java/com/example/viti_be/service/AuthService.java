...
public class AuthService {
    ...
    public void createEmployee(CreateEmployeeRequest request) {
        ...
        user.setStatus("ACTIVE"); // Nhân viên do admin tạo thì Active luôn
    ...
    public void changePassword(String username, String oldPassword, String newPassword) {
        User user = userRepository.findByEmail(username) // Do mình dùng email làm principal
                .orElseThrow(() -> new RuntimeException("User not found"));
        ...
        user.setPassword(passwordEncoder.encode(newPassword));
        user.setIsFirstLogin(false); // Đổi xong tắt cờ first login
        userRepository.save(user);
    }
    ...
    public JwtResponse loginWithGoogle(String idTokenString) throws Exception {
        ...
        if (idToken != null) {
            ...
            User user = userRepository.findByEmail(email).orElseGet(() -> {
                ...
                Role role = roleRepository.findByName("ROLE_CUSTOMER").orElse(null);
                if(role != null) {
            ...
            return new JwtResponse(jwt, user.getId(), user.getUsername(), user.getEmail(), roles, user.getIsFirstLogin());
        } else {
